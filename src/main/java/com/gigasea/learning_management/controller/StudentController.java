...
public class StudentController {
    ...
    // New method to filter students by gender
    @GetMapping("/studentsByGender")
    public String getStudentsByGender(@RequestParam String gender, Model model) {
        List<Student> students = studentService.getStudentsByGender(gender);
        model.addAttribute("students", students);
        return "students";  // You can return a new view or reuse the existing "students" view
    }
}
